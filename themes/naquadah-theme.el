...
(let ((light-blue "#72A0CF")
  ...
  `(term-color-black ((t (:foreground "black" :background ,background))))
  `(term-color-red ((t (:foreground ,red :background ,background))))
  `(term-color-green ((t (:foreground ,green :background ,background))))
  `(term-color-yellow ((t (:foreground ,yellow :background ,background))))
  `(term-color-blue ((t (:foreground ,blue :background ,background))))
  `(term-color-magenta ((t (:foreground ,violet-blue :background ,background))))
  `(term-color-cyan ((t (:foreground ,orange :background ,background))))
  `(term-color-white ((t (:foreground "white" :background ,background))))
